...
public class ShopAdapter_Title$PinViewHolder_ViewBinding<T extends ShopAdapter_Title.PinViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public ShopAdapter_Title$PinViewHolder_ViewBinding(T target, View source) {
    this.target = target;
