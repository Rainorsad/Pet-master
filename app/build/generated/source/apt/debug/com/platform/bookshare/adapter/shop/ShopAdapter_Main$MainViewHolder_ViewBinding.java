...
public class ShopAdapter_Main$MainViewHolder_ViewBinding<T extends ShopAdapter_Main.MainViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public ShopAdapter_Main$MainViewHolder_ViewBinding(T target, View source) {
    this.target = target;
