...
import com.platform.bookshare.zxing.utils.ScanCodeCaptureActivityHandler;
...
public final class ScanCodeActivity extends Activity implements
    ...
    private ScanCodeCaptureActivityHandler handler;
    private InactivityTimer inactivityTimer;
    private BeepManager beepManager;
    private Context context;
    private Intent it;
    private String substr;//解析到的userId
    private String agentid;//机构信息
        ...
        if (resultString.equals("")) {
            ...
            if (result.contains("www.haoban.cn")) {
                ...
                if (result.contains("user")) {
                    substr = result.substring(pos + 6, result.length() - 1);
                    if(substr.equals("null") || substr.equals("(null)") || substr.equals("{(null)}")){
                        Log.d(TAG,"ID为空，无法访问此二维码");
                        return;
                    }
                    Log.d(TAG,"二维码测试    "+substr);
...
//                startActivity(it);
        ...
        System.out.println("result + ding = "+rawResult.getText());
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        try {
            ...
            // RuntimeException.
            if (handler == null) {
                handler = new ScanCodeCaptureActivityHandler(this, cameraManager,
